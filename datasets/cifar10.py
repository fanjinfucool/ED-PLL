...
from utils.utils_algo import binarize_class, partialize, check_integrity, download_url,generate_uniform_cv_candidate_labels
    ...
    def __init__(self, root, train_or_not=True, download=False, transform=None, target_transform=None,
        ...
        if self.train:
            ...
            if partial_rate != 0.0:
                ...
                self.train_final_labels  = generate_uniform_cv_candidate_labels(torch.Tensor(self.train_labels).long(), partial_rate)
